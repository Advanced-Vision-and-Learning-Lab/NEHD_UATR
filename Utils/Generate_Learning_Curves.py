...
def Plot_Learning_Curves(train_acc, train_loss, val_acc, val_loss, best_epoch, sub_dir):
    ...
    loss_ax.plot(
        [best_epoch], val_loss[best_epoch], marker="o", markersize=3, color="red"
    )
    ...
    loss_ax.legend(
        ["Training", "Validation", "Best Epoch"],
    ...
    plt.plot(train_acc)
    plt.plot(val_acc)
    plt.plot([best_epoch], val_acc[best_epoch], marker="o", markersize=3, color="red")
